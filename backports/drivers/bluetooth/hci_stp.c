...
#define CUSTOM_BT_CFG_FILE          "/nvram/APCFG/APRDEB/BT_Addr"
#define INTERNAL_BT_CFG_FILE        "/data/BT_Addr"
...
static unsigned char bt_set_bd_addr[10] =
    {0x01, 0x1A, 0xFC, 0x06, 0x01, 0x46, 0x65, 0x46, 0x00, 0x00};
...
static int hci_stp_flush(struct hci_dev *hdev)
{
    ...
    hu = (struct hci_stp *)hci_get_drvdata(hdev);
